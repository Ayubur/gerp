            ...
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="/#">
                      {/* <i className="bx bx-cart" /> */}
                      <span>{this.props.t("Sell")}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/crypto-buy-sell">
                      {/* <i className="bx bx-support" /> */}
                      <span>{this.props.t("CRM")}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/#">
                      {/* <i className="bx bx-book-content" /> */}
                      <span>{this.props.t("Sales Orders")}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/#">
                  ...
                  <li>
                    <Link to="/#">
                      ...
                      <span>{this.props.t("RMA (Return Merchandise Authorizations)")}</span>
                    </Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                <Link to="/#" className="has-arrow">
                  ...
                  <span>{this.props.t("Pick Pack Ship")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="/#">
                      {/* <i className="fas fa-truck" /> */}
                      <span>{this.props.t("Pick")}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/#">
                      {/* <i className="fas fa-box-open" /> */}
                      <span>{this.props.t("Pack")}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/#">
                      {/* <i className="fas fa-shipping-fast fa-xs" /> */}
                      <span>{this.props.t("Shipping")}</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/crypto-lending">
                      {/* <i className="fas fa-project-diagram" /> */}
                      <span>{this.props.t("Shipping Integrations")}</span>
                    </Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                    ...
                    <ul className="sub-menu" aria-expanded="false">
                      <li>
                        <Link to="/#">
                          ...
                          <span>{this.props.t("Add Intial Inventory")}</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/#">
                          {/* <i className="bx bx-list-check" /> */}
                          <span>{this.props.t("Stock Quantity Check")}</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/#">
                          {/* <i className="bx bx-transfer" /> */}
                          <span>{this.props.t("Move Inventory")}</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/#">
                          {/* <i className="bx bx-adjust" /> */}
                          <span>{this.props.t("Cycle Count/ Adjust Inventory")}</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/#">
                          {/* <i className="bx bx-list-check" /> */}
                          <span>{this.props.t("Scrap Quantity")}</span>
                        </Link>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <Link to="/#">
                      {this.props.t("Kitting")}
                    </Link>
                  </li>
                  <li>
                    <Link to="/#">{this.props.t("Transfer")}</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                <Link to="/#" className="has-arrow">
                  ...
                  <span>{this.props.t("Purchase")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="/#">{this.props.t("Purchase Orders")}</Link>
                  </li>
                  <li>
                    <Link to="/#">
                      {this.props.t("Receiving")}
                    </Link>
                  </li>
                  <li>
                    <Link to="/#">
              ...
              <li>
                <Link to="/#" className="has-arrow">
                  ...
                  <span>{this.props.t("Accounting")}</span>
                </Link>
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="/crypto-wallet">{this.props.t("Overview")}</Link>
                  </li>
                  <li>
                    <Link to="/crypto-buy-sell">
                  ...
                  <li>
                    <Link to="/crypto-exchange">
                      {this.props.t("Chart of Accounts")}
                    </Link>
                  </li><li>
                    <Link to="/crypto-exchange">
                      {this.props.t("Reconcile")}
                    </Link>
                  </li><li>
                    <Link to="/crypto-exchange">
                      {this.props.t("Tax")}
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="/#">{this.props.t("Amazon")}</Link>
                  </li>
                  <li>
                    <Link to="/#">
                      {this.props.t("Ebay")}
